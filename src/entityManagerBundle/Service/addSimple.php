...
class addSimple
{
    ...
    public function render($EntityPattern,$staticParams=null)
    {
        ...
        foreach($YamlForm['items'] as $key=>$item)
        {
            ...
            {
                $form->add($key, TextType::class,array('label'=>$item['title'],'attr'=>array('class' => 'input-sm')));
            }
            elseif ($item['type'] == 'NumberType')
            {
                $form->add($key, NumberType::class,array('label'=>$item['title'],'attr'=>array('class' => 'input-sm')));
            }
            ...
            {
                $form->add($key, CKEditorType::class,array('label'=>$item['title'],'attr'=>array('class' => 'input-sm')));
            }
            elseif ($item['type'] == 'TextareaType')
            {
                $form->add($key, TextareaType::class,array('label'=>$item['title'],'attr'=>array('class' => 'input-sm')));
            }
    ...
    public function submit($EntityPattern,$form)
    {
        ...
        $entityStr = '\\' . $entityAdr[0].'\\Entity\\' . $entityAdr[1];
